...
Este cronograma está diseñado para guiar el desarrollo de la aplicación **NoteUI** durante 5 o 7 sesiones de clase (una por semana). El proyecto está pensado para estudiantes que están iniciando su aprendizaje en JavaScript, por lo que cada sesión avanza de forma progresiva, integrando HTML, CSS y lógica básica con JavaScript.
